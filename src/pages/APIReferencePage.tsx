...
const response = await fetch(\`https://drap-sandbox.digitnine.com/raas/masters/v1/banks/\${bankId}/branches\`, {
  method: 'GET',
  headers: {
    'Content-Type': 'application/json',
    'sender': 'testagentae',
...
const response = await fetch(\`https://drap-sandbox.digitnine.com/raas/masters/v1/banks/\${bankId}/branches/\${branchId}\`, {
  method: 'GET',
  headers: {
    'Content-Type': 'application/json',
    'sender': 'testagentae',
